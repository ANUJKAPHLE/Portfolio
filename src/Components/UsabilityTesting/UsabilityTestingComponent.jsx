const UsabilityTestingComponent = () => {
  return (
    <div className="pl-[86px] h-[1138px]">
        ...
        <div className=" bg-black text-white rounded-[40px] flex">
          <div className="pt-8 pl-16 pb-32 w-1/2">
            ...
            <p className="leading-[27px] w-[489px] mt-3">
              The primary objective of this usability testing study is to
              evaluate the user-friendliness, efficiency, and overall experience
              of the Human Resource Management (HRM) system. The study aims to
              identify any usability issues, gather user feedback, and provide
              actionable insights to improve the system's design and
              functionality.
            </p>
            ...
            <p className="leading-[27px] mt-4 w-[555px]">
              The usability testing study was facilitated by a team of
              experienced usability professionals. Lead facilitator Suzan
              Pradhan, an expert in UX design with over 5 years of experience,
            ...
            <p className="leading-[27px] mt-4 w-[489px]">
              ...
              August 12-14, 2022, at Soft nine office , located at New
              baneshwor, Kathmandu
            </p>
            <p className="text-[24px] leading-[36px] font-semibold mt-8">
              Participants
            ...
            <p className="leading-[27px] mt-4 w-[555px]">
              ...
              technical proficiency. Participants will perform essential HR
              tasks, including logging in, navigating the dashboard, updating
              employee information, processing leave requests, managing payroll,
              and conducting performance evaluations. We will collect data
              through observations, think-aloud protocols, surveys, and
              interviews.
            </p>
          </div>
          <div className="pt-8 pl-9 w-1/2 h-[864px]">
            ...
            <p className="leading-[27px] w-[619px] mt-3">
              ...
              complete successfully without any assistance or errors. It is a
              key indicator of the system's usability and effectiveness.
            </p>
            ...
            <div className="w-[619px] h-[864px]">
              <p className="leading-[27px] mt-4">
                Procedure:
                <br />
                1. Scenario: The participant is given a scenario where an
                employee has submitted a leave request, and the participant
                needs to review and approve or reject it using the HRM system.
                <br /> 2. Steps:
              ...
              <p className="leading-[27px] mt-6">
                ...
                <br />- Tasks Successfully Completed Without Assistance or
                Errors
              </p>
            </div>
          </div>
