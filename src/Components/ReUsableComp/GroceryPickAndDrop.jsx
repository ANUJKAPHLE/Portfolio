...
const GroceryPickAndDrop = ({ heading, text, theme, image, className }) => {
  return (
    <div className={twMerge("pt-9 px-[91px]", className)}>
      <div>
      ...
      <div className="mt-24 flex justify-center gap-x-52 h-auto w-auto">
        <div className=" relative">
          ...
          <div className="w-[423px] h-[1922px] relative">
            <div className="w-[445px] h-[900px] absolute top-0 left-0">
        ...
        <div className="relative mt-32">
          ...
          <div className="w-[423px] h-[1800px] relative">
            <div className="w-[445px] h-[900px] absolute top-0 left-0">
              <Image src={mbl} alt="mbl" className="w-full h-full" />
            </div>
            <div className="pl-5 pt-4">
